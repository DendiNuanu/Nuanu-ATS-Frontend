  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        <MetricCard icon={Send} label="Total Sent" value="148" trend={{ value: "+12", direction: "up" }} />
        <MetricCard icon={Clock} label="Pending" value="23" accent="text-amber-600 bg-amber-50" />
        <MetricCard icon={CheckCircle2} label="Completed" value="112" trend={{ value: "+8", direction: "up" }} accent="text-emerald-600 bg-emerald-50" />
        <MetricCard icon={ClipboardList} label="Avg Score" value="84%" trend={{ value: "+3%", direction: "up" }} />
      </div>
