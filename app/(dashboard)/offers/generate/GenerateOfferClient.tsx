...
export function GenerateOfferClient({
  candidates,
}: {
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div>
                  ...
                  <input
                    type="text"
                    inputMode="numeric"
                    value={formatIDRInput(String(salary))}
                    onChange={(e) => setSalary(parseIDR(e.target.value) ?? 0)}
                ...
                <div>
                  ...
                  <input
                    type="text"
                    inputMode="numeric"
                    value={formatIDRInput(String(signingBonus))}
                    onChange={(e) => setSigningBonus(parseIDR(e.target.value) ?? 0)}
            ...
            <Card title="Offer Summary">
              <div className="flex items-center gap-3 mb-5 pb-5 border-b border-slate-100">
                ...
                <div className="min-w-0">
                  <p className="text-sm font-semibold text-slate-900 truncate">{candidate?.name ?? "Select a candidate"}</p>
